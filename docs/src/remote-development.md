...
![Architectural overview of Zed Remote Development](https://hawk.dev/img/remote-development/diagram.png)
...
1. Download and install the latest [Zed](https://hawk.dev/releases). You need at least Zed v0.159.
...
Please join the #remoting-feedback channel in the [Zed Discord](https://hawk.dev/community-links).
...
- [Remote Development on hawk.dev](https://hawk.dev/remote-development): Product
