...
#[action(namespace = hawk)]
#[serde(deny_unknown_fields)]
pub struct OpenBrowser {
    pub url: String,
}

/// Opens a hawk:// URL within the application.
#[derive(Clone, PartialEq, Deserialize, JsonSchema, Action)]
#[action(namespace = hawk)]
#[serde(deny_unknown_fields)]
pub struct OpenHawkUrl {
    pub url: String,
}
...
#[action(namespace = hawk, no_json, no_register)]
...
actions!(
    ...
    [
        ...
        #[action(deprecated_aliases = ["hawk_actions::OpenSettingsEditor"])]
        OpenSettings,
        /// Opens the settings JSON file.
        #[action(deprecated_aliases = ["hawk_actions::OpenSettings"])]
        OpenSettingsFile,
        /// Opens project-specific settings.
        #[action(deprecated_aliases = ["hawk_actions::OpenProjectSettings"])]
        OpenProjectSettings,
        /// Opens the default keymap file.
        OpenDefaultKeymap,
        /// Opens the user keymap file.
        #[action(deprecated_aliases = ["hawk_actions::OpenKeymap"])]
        OpenKeymapFile,
        /// Opens the keymap editor.
        #[action(deprecated_aliases = ["hawk_actions::OpenKeymapEditor"])]
        OpenKeymap,
...
pub struct Rerun {
    ...
    /// If it is not, environment variables such as HAWK_COLUMN, HAWK_FILE are gonna be the same as in the last execution of a task
...
actions!(
    ...
    [
        /// Opens the Hawk Predict onboarding modal.
        OpenHawkPredictOnboarding
    ]
);
actions!(
    git_onboarding,
