...
impl ZedAiOnboarding {
    ...
    fn render_sign_in_disclaimer(&self, _cx: &mut App) -> AnyElement {
        ...
        v_flex()
            .relative()
            .gap_1()
            .child(Headline::new("Welcome to Hawk AI"))
            .child(
                Label::new("Sign in to try Hawk Pro for 14 days, no credit card required.")
                    .color(Color::Muted)
                    .mb_2(),
            )
    ...
    fn render_trial_state(&self, _cx: &mut App) -> AnyElement {
        v_flex()
            .relative()
            .gap_1()
            .child(Headline::new("Welcome to the Hawk Pro Trial"))
            .child(
    ...
    fn render_pro_plan_state(&self, _cx: &mut App) -> AnyElement {
        v_flex()
            .gap_1()
            .child(Headline::new("Welcome to Hawk Pro"))
            .child(
