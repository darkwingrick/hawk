...
/// Whether Hawk is running in stateless mode.
/// When true, Hawk will use in-memory databases instead of persistent storage.
pub static HAWK_STATELESS: LazyLock<bool> = bool_env_var!("HAWK_STATELESS");
