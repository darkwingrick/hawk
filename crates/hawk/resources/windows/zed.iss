...
[Files]
Source: "{#ResourcesDir}\Hawk.exe"; DestDir: "{code:GetInstallDir}"; Flags: ignoreversion
...
Root: HKCU; Subkey: "Software\Classes\zed\DefaultIcon"; ValueType: "string"; ValueData: "{app}\Hawk.exe,1"
Root: HKCU; Subkey: "Software\Classes\zed\shell\open\command"; ValueType: "string"; ValueData: """{app}\Hawk.exe"" ""%1"""
