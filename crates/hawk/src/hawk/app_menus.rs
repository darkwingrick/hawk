...
pub fn app_menus(cx: &mut App) -> Vec<Menu> {
    ...
    let mut view_items = vec![
        MenuItem::action(
            "Zoom In",
            hawk_actions::IncreaseBufferFontSize { persist: false },
        ),
        MenuItem::action(
            "Zoom Out",
            hawk_actions::DecreaseBufferFontSize { persist: false },
        ),
        MenuItem::action(
            "Reset Zoom",
            hawk_actions::ResetBufferFontSize { persist: false },
        ),
        MenuItem::action(
            "Reset All Zoom",
            hawk_actions::ResetAllZoom { persist: false },
        ),
        MenuItem::separator(),
        ...
        MenuItem::separator(),
        MenuItem::action("Project Panel", hawk_actions::project_panel::ToggleFocus),
    ...
    vec![
        Menu {
            name: "Hawk".into(),
            items: vec![
                MenuItem::action("About Hawk", hawk_actions::About),
                ...
                MenuItem::submenu(Menu {
                    ...
                    items: vec![
                        ...
                        MenuItem::separator(),
                        MenuItem::action("Open Keymap", hawk_actions::OpenKeymap),
                        MenuItem::action("Open Keymap File", hawk_actions::OpenKeymapFile),
                        MenuItem::action(
                        ...
                        MenuItem::action(
                            "Select Theme...",
                            hawk_actions::theme_selector::Toggle::default(),
                        ),
                        MenuItem::action(
                            "Select Icon Theme...",
                            hawk_actions::icon_theme_selector::Toggle::default(),
                        ),
                    ],
                }),
                MenuItem::separator(),
                ...
                MenuItem::separator(),
                MenuItem::action("Extensions", hawk_actions::Extensions::default()),
                #[cfg(not(target_os = "windows"))]
                MenuItem::action("Install CLI", install_cli::InstallCliBinary),
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Hawk", super::Hide),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Others", super::HideOthers),
                #[cfg(target_os = "macos")]
                MenuItem::action("Show All", super::ShowAll),
                MenuItem::separator(),
                MenuItem::action("Quit Hawk", Quit),
            ],
        },
        Menu {
            name: "File".into(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::separator(),
                MenuItem::action("Command Palette...", hawk_actions::command_palette::Toggle),
                MenuItem::separator(),
                MenuItem::action("Go to File...", workspace::ToggleFileFinder::default()),
                // MenuItem::action("Go to Symbol in Project", project_symbols::Toggle),
                MenuItem::action(
                    "Go to Symbol in Editor...",
                    hawk_actions::outline::ToggleOutline,
                ),
        ...
        Menu {
            ...
            items: vec![
                MenuItem::action(
                    "Spawn Task",
                    hawk_actions::Spawn::ViaModal {
                        reveal_target: None,
                    },
                ),
                MenuItem::action("Start Debugger", debugger_ui::Start),
                MenuItem::separator(),
                MenuItem::action("Edit tasks.json...", crate::hawk::OpenProjectTasks),
                MenuItem::action("Edit debug.json...", hawk_actions::OpenProjectDebugTasks),
                MenuItem::separator(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action("Email Us...", hawk_actions::feedback::EmailZed),
                MenuItem::separator(),
                MenuItem::action(
                    "Documentation",
                    super::OpenBrowser {
                        url: "https://github.com/darkwingrick/hawk/tree/master/docs".into(),
                    },
                ),
                MenuItem::action("Hawk Repository", feedback::OpenZedRepo),
                MenuItem::action(
                    "Hawk Twitter",
                    super::OpenBrowser {
                        url: "https://twitter.com/hawkdotdev".into(),
                    },
                ),
                MenuItem::action(
                    "Join the Team",
                    super::OpenBrowser {
                        url: "https://hawk.dev/jobs".into(),
                    },
                ),
            ],
        },
