...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Hawk Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Hawk Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Hawk Editor Preview Instance Running",
        ReleaseChannel::Stable => "Hawk Editor Stable Instance Running",
    }
}
