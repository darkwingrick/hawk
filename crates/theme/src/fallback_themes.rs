...
use crate::{
    AccentColors, Appearance, PlayerColors, StatusColors,
...
pub(crate) fn hawk_default_dark() -> Theme {
    let bg = hsla(135. / 360., 20. / 100., 5. / 100., 1.);
    let editor = hsla(135. / 360., 20. / 100., 8. / 100., 1.);
    let elevated_surface = hsla(135. / 360., 20. / 100., 10. / 100., 1.);
    let hover = hsla(140. / 360., 50. / 100., 15. / 100., 1.0);

    let blue = hsla(144. / 360., 80. / 100., 40. / 100., 1.0);
    let gray = hsla(135. / 360., 10. / 100., 50. / 100., 1.0);
    let green = hsla(144. / 360., 70. / 100., 50. / 100., 1.0);
    ...
    Theme {
        ...
        styles: ThemeStyles {
            ...
            colors: ThemeColors {
                border: hsla(135. / 360., 13. / 100., 12. / 100., 1.),
                border_variant: hsla(135. / 360., 8. / 100., 25. / 100., 1.),
                border_focused: blue,
                border_selected: blue,
                border_transparent: SystemColors::default().transparent,
                border_disabled: hsla(135.0 / 360., 11.6 / 100., 33.7 / 100., 1.0),
                elevated_surface_background: elevated_surface,
                surface_background: bg,
                background: bg,
                element_background: hsla(135.0 / 360., 13. / 100., 21. / 100., 1.0),
                element_hover: hover,
                element_active: hsla(135.0 / 360., 11.8 / 100., 20.0 / 100., 1.0),
                element_selected: hsla(135.0 / 360., 11.3 / 100., 26.1 / 100., 1.0),
                element_disabled: SystemColors::default().transparent,
                element_selection_background: player.local().selection.alpha(0.25),
                drop_target_background: hsla(135.0 / 360., 8.3 / 100., 21.4 / 100., 1.0),
                drop_target_border: hsla(135. / 360., 11. / 100., 86. / 100., 1.0),
                ghost_element_background: SystemColors::default().transparent,
                ghost_element_hover: hover,
                ghost_element_active: hsla(135.0 / 360., 11.8 / 100., 20.0 / 100., 1.0),
                ghost_element_selected: hsla(135.0 / 360., 11.3 / 100., 26.1 / 100., 1.0),
                ghost_element_disabled: SystemColors::default().transparent,
                text: hsla(135. / 360., 4. / 100., 86. / 100., 1.0),
                text_muted: hsla(135. / 360., 4. / 100., 86. / 100., 1.0),
                text_placeholder: hsla(135. / 360., 10. / 100., 50. / 100., 1.0),
                text_disabled: hsla(135. / 360., 10. / 100., 50. / 100., 1.0),
                text_accent: hsla(144. / 360., 77.5 / 100., 65.1 / 100., 1.0),
                icon: hsla(135. / 360., 9.9 / 100., 86.1 / 100., 1.0),
                icon_muted: hsla(135. / 360., 12.1 / 100., 66.1 / 100., 1.0),
                icon_disabled: hsla(135. / 360., 6.4 / 100., 45.7 / 100., 1.0),
                icon_placeholder: hsla(135. / 360., 6.4 / 100., 45.7 / 100., 1.0),
                icon_accent: blue,
                debugger_accent: red,
                ...
                tab_bar_background: hsla(135. / 360., 20. / 100., 3. / 100., 1.),
                tab_inactive_background: hsla(135. / 360., 20. / 100., 3. / 100., 1.),
                tab_active_background: hsla(135. / 360., 20. / 100., 12. / 100., 1.),
                ...
                editor_active_line_background: hsla(135. / 360., 13.5 / 100., 20.4 / 100., 1.0),
                editor_highlighted_line_background: hsla(144. / 360., 81. / 100., 66. / 100., 0.1),
                ...
                editor_line_number: hsla(135.0 / 360., 11.5 / 100., 34.1 / 100., 1.0),
                editor_active_line_number: hsla(135.0 / 360., 5.9 / 100., 49.6 / 100., 1.0),
                editor_hover_line_number: hsla(135.0 / 360., 5.9 / 100., 56.7 / 100., 1.0),
                editor_invisible: hsla(135.0 / 360., 11.5 / 100., 34.1 / 100., 1.0),
                editor_wrap_guide: hsla(135. / 360., 8. / 100., 25. / 100., 1.),
                editor_active_wrap_guide: hsla(135. / 360., 8. / 100., 25. / 100., 1.),
                editor_indent_guide: hsla(135. / 360., 8. / 100., 25. / 100., 1.),
                editor_indent_guide_active: hsla(135. / 360., 13. / 100., 12. / 100., 1.),
                ...
                panel_indent_guide: hsla(135. / 360., 8. / 100., 25. / 100., 1.),
                panel_indent_guide_hover: hsla(135. / 360., 13. / 100., 12. / 100., 1.),
                panel_indent_guide_active: hsla(135. / 360., 13. / 100., 12. / 100., 1.),
                panel_overlay_background: bg,
                panel_overlay_hover: hover,
                pane_focused_border: blue,
                pane_group_border: hsla(135. / 360., 13. / 100., 12. / 100., 1.),
                ...
                scrollbar_thumb_border: hsla(135. / 360., 8. / 100., 25. / 100., 1.),
                scrollbar_track_background: gpui::transparent_black(),
                scrollbar_track_border: hsla(135. / 360., 8. / 100., 25. / 100., 1.),
                ...
                minimap_thumb_border: hsla(135. / 360., 8. / 100., 25. / 100., 1.),
                editor_foreground: hsla(135. / 360., 4. / 100., 86. / 100., 1.0),
