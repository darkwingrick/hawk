...
x11rb::atom_manager! {
    pub XcbAtoms: AtomsCookie {
        ...
        _NET_WM_NAME,
        _NET_WM_STATE,
        _NET_WM_STATE_MAXIMIHAWK_VERT,
        _NET_WM_STATE_MAXIMIHAWK_HORZ,
...
impl X11WindowStatePtr {
    ...
    fn set_wm_properties(
        ...
        for atom in atoms {
            ...
            } else if atom == state.atoms._NET_WM_STATE_MAXIMIHAWK_VERT {
                state.maximized_vertical = true;
            } else if atom == state.atoms._NET_WM_STATE_MAXIMIHAWK_HORZ {
...
impl PlatformWindow for X11Window {
    ...
    fn zoom(&self) {
        ...
        self.set_wm_hints(
            ...
            state.atoms._NET_WM_STATE_MAXIMIHAWK_VERT,
            state.atoms._NET_WM_STATE_MAXIMIHAWK_HORZ,
        )
        .log_err();
    }
